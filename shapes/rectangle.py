...
class Rectangle(AbstractShape):
    ...
    def draw(self):
        bottom_left_x, bottom_left_y = self._points[0]
        bottom_right_x, bottom_right_y = self._points[1]
        top_right_x, top_right_y = self._points[2]
        top_left_x, top_left_y = self._points[3]
